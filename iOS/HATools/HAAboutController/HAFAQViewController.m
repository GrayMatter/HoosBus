...
#import "HAFAQItemViewController.h"


@implementation HAFAQViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *dict = faqArray[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    NSDictionary *dict = faqArray[indexPath.row];
    NSString *question = dict[@"question"];
    NSString *answer = dict[@"answer"];
    
    HAFAQItemViewController *controller = [[HAFAQItemViewController alloc] initWithStyle:UITableViewStyleGrouped];
